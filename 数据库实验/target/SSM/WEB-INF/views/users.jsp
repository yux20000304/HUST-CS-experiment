    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li><a href="/backtomanagerpage/${managername}">管理员主页</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div>
                <table class="table table-stripped">
                    <thread>
                        <form class="form-signin" action="/insertuser/${managername}/1" ,method="get">
                            <th><input name="username" class="form-control" placeholder="用户名" required autofocus></th>

                            <th><input name="password" class="form-control" placeholder="密码" required autofocus></th>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            <li><a href="${APP_PATH}/findusers/${managername}/1">首页</a></li>

                            <%--                        判断是否有上一页（是否是第一页），如果是，则不显示该标签，如果不是，点击可以跳转到上一页--%>
                            <c:if test="${pageInfo.hasPreviousPage}">
                                <li>
                                    <a href="${APP_PATH}/findusers/${managername}/${pageInfo.pageNum - 1}" aria-label="Previous">
                            ...
                            <c:forEach items="${pageInfo.navigatepageNums}" var="page_num">
                                ...
                                <c:if test="${page_num != pageInfo.pageNum}">
                                    ...
                                    <li><a href="${APP_PATH}/findusers/${managername}/${page_num}">${page_num}</a></li>
                                </c:if>
                            </c:forEach>
                            ...
                            <c:if test="${pageInfo.hasNextPage}">
                                <li>
                                    <a href="${APP_PATH}/findusers/${managername}/${pageInfo.pageNum + 1}" aria-label="Next">
                                        <span aria-hidden="true">&raquo;</span>
                                    </a>
                                </li>
                            </c:if>

                            <li><a href="${APP_PATH}/findusers/${managername}/${pageInfo.pages}">尾页</a></li>
                        </ul>
                    </nav>
