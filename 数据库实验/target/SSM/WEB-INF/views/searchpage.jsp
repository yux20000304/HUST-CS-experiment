            ...
            <div class="col-xs-6 col-sm-3 placeholder">
                ...
                <div>
                    <table class="table table-stripped">
                        <thread>
                            <form class="form-signin" action="/findsubscribe/${userid}/1" ,method="get">
                                ...
                                <th><input name="year" type="number" class="form-control" placeholder="year" required
                                           autofocus></th>
                                <th><input name="month" type="number" class="form-control" placeholder="month" required
                                           autofocus></th>
                                <th><input name="day" type="number" class="form-control" placeholder="day" required
                                           autofocus></th>
                                <th><button class="btn btn-lg btn-primary btn-block" type="submit">查询</button></th>
                            </form>
                        </thread>
