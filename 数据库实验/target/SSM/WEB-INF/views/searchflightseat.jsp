        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div>
                <table class="table table-stripped">
                    <thread>
                        <form class="form-signin" action="/findflightseat/${userid}/1" ,method="get">
                            <th><input name="flightinfo" style="height: 30px" class="form-control" placeholder="航班号" required autofocus></th>
