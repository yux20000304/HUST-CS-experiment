            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            <li><a href="${APP_PATH}/withdrawinfo/${userid}/1">首页</a></li>

                            <%--                        判断是否有上一页（是否是第一页），如果是，则不显示该标签，如果不是，点击可以跳转到上一页--%>
                            <c:if test="${pageInfo.hasPreviousPage}">
                                <li>
                                    <a href="${APP_PATH}/withdrawinfo/${userid}/${pageInfo.pageNum - 1}" aria-label="Previous">
                            ...
                            <c:forEach items="${pageInfo.navigatepageNums}" var="page_num">
                                ...
                                <c:if test="${page_num != pageInfo.pageNum}">
                                    ...
                                    <li><a href="${APP_PATH}/withdrawinfo/${userid}/${page_num}">${page_num}</a></li>
                                </c:if>
                            </c:forEach>
                            ...
                            <c:if test="${pageInfo.hasNextPage}">
                                <li>
                                    <a href="${APP_PATH}/withdrawinfo/${userid}/${pageInfo.pageNum + 1}" aria-label="Next">
                                        <span aria-hidden="true">&raquo;</span>
                                    </a>
                                </li>
                            </c:if>

                            <li><a href="${APP_PATH}/withdrawinfo/${userid}/${pageInfo.pages}">尾页</a></li>
                        </ul>
                    </nav>
