    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li><a href="/findairinfo/${userid}/1">航班信息</a></li>
                <li><a href="/findbookinfo/${userid}/1">订单信息</a></li>
                <li><a href="/suitairinfo/${userid}">订票页面</a></li>
                <li><a href="/gotocancelbook/${userid}/1">退订页面</a></li>
            </ul>
            <ul class="nav nav-sidebar">
                <li><a href="/searchairseatinfo/${userid}">航班座位信息</a></li>
                <li><a href="/billinfo/${userid}/1">账单信息</a></li>
                <li><a href="/withdrawinfo/${userid}/1">取票信息</a></li>
